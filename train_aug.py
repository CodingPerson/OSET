...
parser.add_argument('--lamb', default=0.5, type=float, help='lambda')
parser.add_argument('--open_lamda', default=0.5, type=float, help='lambda')
parser.add_argument('--p_cutoff', default=0.9, type=float, help='lambda')
...
if __name__ == '__main__':
    ...
    output_f = open(os.path.join('checkpoints', args.data, 'aug_output_base_new.txt'), 'a+')
    ...
    output_f.write("ova_flag=" + str(args.ova_flag) + '\n')
    print(("ova_flag=" + str(args.ova_flag)))
