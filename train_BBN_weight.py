...
if __name__ == '__main__':
    ...
    output_f = open(os.path.join('checkpoints', args.data, 'aug_output_PLM_new.txt'), 'a+')
    ...
    for epoch in range(args.max_epoch):
        ...
        if macro_f1_id_avg > best_macro_f1_id_avg:
            ...
            save(best_macro_f1_id_avg, best_macro_f1_id_avg,
                 os.path.join('checkpoints', args.data, 'checkpoint_best_acc_PLM_lamb_'+str(args.lamb)+'_ood_'+str(args.ood_flag)+'_contrast_'+str(args.contrast)+'.pt'))
            early_stop_count = 0
