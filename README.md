...
We provide all generated pseudo unknown-type instances in the folder `checkpoints` (You need to extract the compressed files with a `.zip` extension). Based on these instances, you can run the following command to reproduce the results
